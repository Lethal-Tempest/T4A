  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col gap-3 w-full items-start'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>setName(e.target.value)} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Product Name' />
      </div>
      <div className='w-full'>
        <p className='mb-2'>Product Description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Product Description' />
      </div>
      ...
      <div>
        ...
        <div className='flex gap-2 mt-2'>
          <input onChange={(e)=>setBestseller(e.target.checked?"true":"false")} type='checkbox' id='bestseller' />
