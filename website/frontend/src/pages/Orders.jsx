            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
                ...
                <div className='md:w-1/2 flex justify-between'>
                  ...
                  <button className='border border-gray-100 px-4 py-2 text-sm font-medium rounded-sm cursor-pointer hover:bg-gray-100 transition-all ease-in-out duration-100'>Track Order</button>
                </div>
              </div>
            )
          })
